    ...
    body: ListView(
      children: const [
        ListTile(
          ...
          title: Text('Bible Resources'),
        ),
        ListTile(
          leading: Icon(Icons.lightbulb_outline),
          title: Text('Devotions'),
        ),
        ListTile(leading: Icon(Icons.school_outlined), title: Text('Courses')),
        ListTile(
          leading: Icon(Icons.groups_2_outlined),
          title: Text('Life Groups'),
        ),
        ListTile(leading: Icon(Icons.favorite_outline), title: Text('Prayer')),
      ],
    ),
  );
}
